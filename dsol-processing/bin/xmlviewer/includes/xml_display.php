        ...
        <td>
         <?php
          if (in_array(preg_replace("/\d+$/","",$key), $editable)) :
            if (strlen($val) <= 29) : ?>
              <div class="col-md-10">
                <input type="text" class="form-control" id="<?php echo $id; ?>" name="<?php echo $id; ?>" value="<?php echo $val; ?>">
              </div>
              <?php
            else: ?>
              <textarea class="form-control" rows="<?php echo floor(strlen($val) / 35); ?>" name="<?php echo $id; ?>" id="<?php echo $id; ?>"><?php echo $val; ?></textarea>
            <?php
            endif;
          else: ?>
          <div class="col-md-10">
