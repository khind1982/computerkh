...
// /xmlviewer/npp/images/P000002/19730801/01/images/NPP000002_19730801_01-007.jpg
$image_path = $os->join('/xmlviewer/', $product[2]);
$image_path = $os->join($image_path, '/images');
$image_path = $os->join($image_path, substr($current_path, 24, -4));
$image_path = $os->join($image_path, '/images');
